...
# dfu = pd.read_csv("/Users/ziweishi/Desktop/DFU/dfu_PseudoColor_list.csv")
# df = pd.read_excel("/Users/ziweishi/Documents/database/DFU_Master_ImageCollections.xlsx")
#
# # "006-001_1_awcm_SS_56.json"
#
# guid_list = dfu["ImgCollGUID"].to_list()
#
# date_time = []
#
# mid_time_list=[]
...
def parse_mid_date(x):
    stamp = int(x) - 2209031999999999700 - 21600000000000
    print(stamp)
    eval = str(pd.to_datetime(stamp).strftime("%d-%m-%Y, %H:%M:%S"))
    return eval
